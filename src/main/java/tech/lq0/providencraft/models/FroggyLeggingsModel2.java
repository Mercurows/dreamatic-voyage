...
public class FroggyLeggingsModel2<T extends LivingEntity> extends BipedModel<T> {
	...
	public FroggyLeggingsModel2() {
		...
		body.setRotationPoint(0.0F, 12.5F, 4.0F);
		...
		left.setRotationPoint(2.0F, 10.0F, 3.0F);
		...
		right.setRotationPoint(3.0F, 7.0F, 2.5F);
