...
public class LunaticBowModel extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main = partdefinition.addOrReplaceChild("main", CubeListBuilder.create(), PartPose.offset(5.0F, 18.0F, 1.0F));
		...
		.texOffs(6, 0).addBox(-0.5F, 1.5F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 0.0F, -0.5F, 0.48F, 0.0F, 0.0F));
		...
		.texOffs(11, 0).addBox(-0.5F, 2.0F, -0.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, -0.6101F, 0.0177F, -0.013F));
