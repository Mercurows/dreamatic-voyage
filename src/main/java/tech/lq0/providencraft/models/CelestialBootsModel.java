...
public class CelestialBootsModel<T extends LivingEntity> extends BipedModel<T> {
	...
	private final ModelRenderer shizija;
	...
	private final ModelRenderer shizija2;
	private final ModelRenderer cube_r42;

	public CelestialBootsModel() {
		super(2.0f);
		...
		left.setRotationPoint(-2.5F, 24.0F, 0.0F);
		...
		cube_r10.setTextureOffset(4, 35).addBox(0.0F, -2.0373F, -2.3434F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		...
		cube_r12.setTextureOffset(33, 0).addBox(0.0F, -2.4239F, -0.8827F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		...
		cube_r18.setTextureOffset(37, 8).addBox(0.0F, -0.3087F, -1.9619F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		...
		cube_r19.setTextureOffset(44, 38).addBox(-0.5F, -1.0373F, -0.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r19.setTextureOffset(39, 6).addBox(-0.5F, -0.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r19.setTextureOffset(0, 41).addBox(-0.5F, -1.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		cube_r20 = new ModelRenderer(this);
		cube_r20.setRotationPoint(0.1F, 1.1401F, -4.9978F);
		star6.addChild(cube_r20);
		setRotationAngle(cube_r20, -0.7854F, 0.0F, 0.0F);
		cube_r20.setTextureOffset(41, 27).addBox(-0.5F, -1.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		shizija = new ModelRenderer(this);
		shizija.setRotationPoint(8.2F, -0.2F, 0.3F);
		left.addChild(shizija);
		

		cube_r21 = new ModelRenderer(this);
		cube_r21.setRotationPoint(0.7F, -3.6F, -4.5F);
		shizija.addChild(cube_r21);
		...
		cube_r21.setTextureOffset(33, 16).addBox(-0.5F, -0.9F, 0.3F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		...
		right.setRotationPoint(2.5F, 24.0F, 0.0F);
		...
		cube_r22.setRotationPoint(-4.0F, -5.0F, -4.5F);
		right.addChild(cube_r22);
		setRotationAngle(cube_r22, -0.2094F, 0.0F, 0.0F);
		cube_r22.setTextureOffset(0, 32).addBox(-5.0F, -0.6F, -0.8F, 10.0F, 2.0F, 11.0F, 0.0F, false);
		...
		cube_r23.setRotationPoint(-0.1F, 1.1401F, -4.9978F);
		star2.addChild(cube_r23);
		setRotationAngle(cube_r23, -0.7854F, 0.0F, 0.0F);
		cube_r23.setTextureOffset(37, 27).addBox(-0.5F, -1.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		cube_r24 = new ModelRenderer(this);
		cube_r24.setRotationPoint(-0.1F, -0.2741F, -4.9978F);
		star2.addChild(cube_r24);
		setRotationAngle(cube_r24, -0.7854F, 0.0F, 0.0F);
		cube_r24.setTextureOffset(33, 27).addBox(-0.5F, -1.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r24.setTextureOffset(0, 27).addBox(-0.5F, -0.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r24.setTextureOffset(31, 41).addBox(-0.5F, -1.0373F, -0.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		cube_r25 = new ModelRenderer(this);
		cube_r25.setRotationPoint(0.0F, -0.2997F, 0.9219F);
		star2.addChild(cube_r25);
		setRotationAngle(cube_r25, -0.48F, 0.0F, 0.0F);
		cube_r25.setTextureOffset(6, 32).addBox(-0.5F, -1.266F, -1.1428F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		cube_r26 = new ModelRenderer(this);
		cube_r26.setRotationPoint(0.0F, -0.2997F, -0.9176F);
		star2.addChild(cube_r26);
		setRotationAngle(cube_r26, -1.0908F, 0.0F, 0.0F);
		cube_r26.setTextureOffset(28, 45).addBox(-0.5F, -1.7588F, -1.4659F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		cube_r27 = new ModelRenderer(this);
		cube_r27.setRotationPoint(0.5F, 0.0259F, 0.0022F);
		star2.addChild(cube_r27);
		setRotationAngle(cube_r27, -0.7854F, 0.0F, 0.0F);
		cube_r27.setTextureOffset(4, 45).addBox(-1.0F, -1.0373F, -1.3434F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		cube_r28 = new ModelRenderer(this);
		cube_r28.setRotationPoint(0.5F, -0.9741F, 0.0022F);
		star2.addChild(cube_r28);
		setRotationAngle(cube_r28, -0.7854F, 0.0F, 0.0F);
		cube_r28.setTextureOffset(0, 45).addBox(-1.0F, -1.0373F, -1.3434F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r29 = new ModelRenderer(this);
		cube_r29.setRotationPoint(0.5F, 0.7803F, -0.551F);
		star2.addChild(cube_r29);
		setRotationAngle(cube_r29, -1.3963F, 0.0F, 0.0F);
		cube_r29.setTextureOffset(0, 38).addBox(-1.0F, -0.4564F, -2.499F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r30 = new ModelRenderer(this);
		cube_r30.setRotationPoint(0.5F, 0.7803F, 0.5553F);
		star2.addChild(cube_r30);
		setRotationAngle(cube_r30, -0.1745F, 0.0F, 0.0F);
		cube_r30.setTextureOffset(31, 38).addBox(-1.0F, -1.4239F, -1.8827F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		...
		STAR5.addChild(cube_r31);
		setRotationAngle(cube_r31, -1.3963F, 0.0F, 0.0F);
		cube_r31.setTextureOffset(5, 0).addBox(-1.0F, -0.0005F, -1.4782F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r32 = new ModelRenderer(this);
		cube_r32.setRotationPoint(-0.5F, -1.08F, -0.3666F);
		STAR5.addChild(cube_r32);
		setRotationAngle(cube_r32, -1.0908F, 0.0F, 0.0F);
		cube_r32.setTextureOffset(46, 27).addBox(-0.5F, -1.017F, -0.6294F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(0.0F, -0.7543F, 0.5531F);
		STAR5.addChild(cube_r33);
		setRotationAngle(cube_r33, -0.7854F, 0.0F, 0.0F);
		cube_r33.setTextureOffset(9, 0).addBox(-1.0F, -0.0783F, -0.7686F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		cube_r34 = new ModelRenderer(this);
		cube_r34.setRotationPoint(-0.5F, -1.08F, 1.4729F);
		STAR5.addChild(cube_r34);
		setRotationAngle(cube_r34, -0.48F, 0.0F, 0.0F);
		cube_r34.setTextureOffset(16, 45).addBox(-0.5F, -0.1786F, -0.883F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		cube_r35 = new ModelRenderer(this);
		cube_r35.setRotationPoint(0.0F, -1.7543F, 0.5531F);
		STAR5.addChild(cube_r35);
		setRotationAngle(cube_r35, -0.7854F, 0.0F, 0.0F);
		cube_r35.setTextureOffset(35, 39).addBox(-1.0F, -0.0783F, -0.7686F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r36 = new ModelRenderer(this);
		cube_r36.setRotationPoint(0.0F, 0.0F, 1.1063F);
		STAR5.addChild(cube_r36);
		setRotationAngle(cube_r36, -0.1745F, 0.0F, 0.0F);
		cube_r36.setTextureOffset(5, 16).addBox(-1.0F, -0.3087F, -1.9619F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		...
		star7.addChild(cube_r37);
		setRotationAngle(cube_r37, -1.3963F, 0.0F, 0.0F);
		cube_r37.setTextureOffset(0, 6).addBox(-1.0F, -1.4564F, -2.499F, 1.0F, 3.0F, 3.0F, 0.0F, false);

		cube_r38 = new ModelRenderer(this);
		cube_r38.setRotationPoint(0.0F, 0.0F, 1.1063F);
		star7.addChild(cube_r38);
		setRotationAngle(cube_r38, -0.1745F, 0.0F, 0.0F);
		cube_r38.setTextureOffset(0, 32).addBox(-1.0F, -2.4239F, -0.8827F, 1.0F, 3.0F, 2.0F, 0.0F, false);

		cube_r39 = new ModelRenderer(this);
		cube_r39.setRotationPoint(-0.5F, -1.08F, 1.4729F);
		star7.addChild(cube_r39);
		setRotationAngle(cube_r39, -0.48F, 0.0F, 0.0F);
		cube_r39.setTextureOffset(0, 0).addBox(-0.5F, -2.266F, -2.1428F, 1.0F, 3.0F, 3.0F, 0.0F, false);

		cube_r40 = new ModelRenderer(this);
		cube_r40.setRotationPoint(0.0F, -1.7543F, 0.5531F);
		star7.addChild(cube_r40);
		setRotationAngle(cube_r40, -0.7854F, 0.0F, 0.0F);
		cube_r40.setTextureOffset(33, 5).addBox(-1.0F, -2.0373F, -2.3434F, 1.0F, 3.0F, 2.0F, 0.0F, false);

		cube_r41 = new ModelRenderer(this);
		cube_r41.setRotationPoint(-0.5F, -1.08F, -0.3666F);
		star7.addChild(cube_r41);
		setRotationAngle(cube_r41, -1.0908F, 0.0F, 0.0F);
		cube_r41.setTextureOffset(5, 19).addBox(-0.5F, -0.7588F, -2.4659F, 1.0F, 2.0F, 3.0F, 0.0F, false);

		shizija2 = new ModelRenderer(this);
		shizija2.setRotationPoint(-8.2F, -0.2F, 0.3F);
		right.addChild(shizija2);
		

		cube_r42 = new ModelRenderer(this);
		cube_r42.setRotationPoint(-0.7F, -3.6F, -4.5F);
		shizija2.addChild(cube_r42);
		setRotationAngle(cube_r42, -0.3665F, 0.0F, 0.0F);
		cube_r42.setTextureOffset(5, 9).addBox(-0.5F, -0.3F, -0.7F, 1.0F, 1.0F, 3.0F, 0.0F, false);
		cube_r42.setTextureOffset(31, 32).addBox(-0.5F, -0.9F, 0.3F, 1.0F, 3.0F, 1.0F, 0.0F, false);
	}
