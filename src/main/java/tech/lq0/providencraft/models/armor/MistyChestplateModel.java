...
public class MistyChestplateModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = right_total.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.offset(-13.0F, 6.0F, 0.0F));
		...
		PartDefinition wing = body.addOrReplaceChild("wing", CubeListBuilder.create().texOffs(0, 6).addBox(10.2431F, -5.9771F, -0.6F, 23.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 2).addBox(7.2431F, -2.9771F, -0.6F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(42, 67).addBox(7.2431F, -1.9771F, -0.6F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(70, 25).addBox(8.2431F, 0.0229F, -0.6F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(70, 25).addBox(8.2431F, 0.0229F, -0.6F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 4).addBox(8.2431F, -4.9771F, -0.6F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(8.2431F, -3.9771F, -0.6F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 11).addBox(11.2431F, 0.0229F, -0.2F, 19.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 8).addBox(11.2431F, -1.9771F, -0.2F, 20.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition left_arm = left_total.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offset(13.0F, 6.0F, 0.0F));
