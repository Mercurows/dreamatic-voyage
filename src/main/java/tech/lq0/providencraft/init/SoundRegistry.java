...
public class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> LEVIY_BEAM = SOUNDS.register("leviy_beam", () -> new SoundEvent(new ResourceLocation(Utils.MOD_ID, "leviy_beam")));
    public static final RegistryObject<SoundEvent> LEVIY_FAIL = SOUNDS.register("leviy_fail", () -> new SoundEvent(new ResourceLocation(Utils.MOD_ID, "leviy_fail")));
