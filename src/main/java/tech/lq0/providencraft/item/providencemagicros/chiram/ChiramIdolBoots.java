...
import tech.lq0.providencraft.models.armor.ChiramIdolBootsModel;
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                HumanoidModel<?> armorModel = new HumanoidModel<>(new ModelPart(Collections.emptyList(), Map.of(
                        ...
                        "right_leg", new ChiramIdolBootsModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(ChiramIdolBootsModel.LAYER_LOCATION)).right_total,
                        "left_leg", new ChiramIdolBootsModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(ChiramIdolBootsModel.LAYER_LOCATION)).left_total)));
