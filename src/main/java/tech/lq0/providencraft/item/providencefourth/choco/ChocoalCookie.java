...
public class ChocoalCookie extends Item {
    private static final Food food = (new Food.Builder()).hunger(2).saturation(0.5f).setAlwaysEdible()
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add((new TranslationTextComponent("des.providencraft.chocoal_cookie")).mergeStyle(TextFormatting.GRAY));
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
        ...
        if (entityLiving instanceof PlayerEntity && !worldIn.isRemote) {
            ...
            player.attackEntityFrom(DamageSourceRegistry.CHOCOAL_COOKIE, 2.0f);
        }
        return itemStack;
    }
