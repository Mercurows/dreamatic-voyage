...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_AXE)
                .add(BlockRegistry.UNI_MILLET_BLOCK.get(), BlockRegistry.HARANO_LOG.get());

        this.tag(BlockTags.MINEABLE_WITH_HOE)
                .add(BlockRegistry.HARANO_LEAVES.get());

        this.tag(BlockTags.BEE_GROWABLES)
                .add(BlockRegistry.UNI_MILLET_BLOCK.get());

        this.tag(BlockTags.CROPS)
                .add(BlockRegistry.UNI_MILLET_BLOCK.get());

        this.tag(BlockTags.SAND)
                .add(BlockRegistry.BLUE_SAND.get());
