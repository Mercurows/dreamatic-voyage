package tech.lq0.dreamaticvoyage.block.basic.harano;
...
public class StrippedHaranoWood extends RotatedPillarBlock {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        pTooltip.add(Component.translatable("des.dreamaticvoyage.stripped_harano_wood").withStyle(ChatFormatting.GRAY));
    }
}
