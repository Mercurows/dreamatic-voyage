package tech.lq0.dreamaticvoyage.block.basic.bluesand;
...
public class ChiseledBlueSandstone extends Block {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        pTooltip.add(Component.translatable("des.dreamaticvoyage.chiseled_blue_sandstone").withStyle(ChatFormatting.GRAY));
    }
}
