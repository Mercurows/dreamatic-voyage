...
public class PotionRegistry {
    ...
    public static final RegistryObject<Potion> BLEEDING = POTIONS.register("dmv_bleeding",
            () -> new Potion(new MobEffectInstance(EffectRegistry.BLEEDING.get(), 1200, 0)));
    public static final RegistryObject<Potion> SUPER_BLEEDING = POTIONS.register("super_dmv_bleeding",
