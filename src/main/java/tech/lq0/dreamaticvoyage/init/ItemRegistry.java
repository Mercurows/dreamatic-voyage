...
import tech.lq0.dreamaticvoyage.item.providenceOI.ayu.GravityRestraintDevice;
import tech.lq0.dreamaticvoyage.item.providenceOI.ccelia.CraftBeer0322;
import tech.lq0.dreamaticvoyage.item.providenceOI.fukami.*;
import tech.lq0.dreamaticvoyage.item.providenceOI.lutafia.Fiaxe;
import tech.lq0.dreamaticvoyage.item.providenceOI.miya.JellyfishShell;
import tech.lq0.dreamaticvoyage.item.providenceOI.miya.TailPen;
import tech.lq0.dreamaticvoyage.item.providenceOI.rino.ClarityAmulet;
import tech.lq0.dreamaticvoyage.item.providenceOI.rino.ShuRinoKen;
import tech.lq0.dreamaticvoyage.item.providenceOI.roky.Xiaolongbao;
import tech.lq0.dreamaticvoyage.item.providenceOI.shirako.*;
import tech.lq0.dreamaticvoyage.item.providenceOI.shirayuki.ButterflyAnklet;
import tech.lq0.dreamaticvoyage.item.providenceOI.shirayuki.FoxFairyFan;
import tech.lq0.dreamaticvoyage.item.providenceOI.sorayo.LunaticBow;
import tech.lq0.dreamaticvoyage.item.providenceOI.sorayo.MoonCake;
import tech.lq0.dreamaticvoyage.item.providenceOI.yesa.MintChocolate;
import tech.lq0.dreamaticvoyage.item.providenceOI.yesa.TailFishingRod;
import tech.lq0.dreamaticvoyage.item.providenceOI.yesa.YeggyPearl;
import tech.lq0.dreamaticvoyage.item.providenceOI.yuri.RabbitLychee;
import tech.lq0.dreamaticvoyage.item.providencefirst.ayelet.CrystalHorn;
import tech.lq0.dreamaticvoyage.item.providencefirst.ayelet.SleepRoulette;
import tech.lq0.dreamaticvoyage.item.providencefirst.haya.BigSpoon;
import tech.lq0.dreamaticvoyage.item.providencefirst.haya.HayaSword;
import tech.lq0.dreamaticvoyage.item.providencefirst.haya.Hayamen;
import tech.lq0.dreamaticvoyage.item.providencefirst.madoka.*;
import tech.lq0.dreamaticvoyage.item.providencefirst.mari.Machete;
import tech.lq0.dreamaticvoyage.item.providencefirst.mari.MagicMirror;
import tech.lq0.dreamaticvoyage.item.providencefirst.mari.MariStew;
import tech.lq0.dreamaticvoyage.item.providencefirst.myanna.DarkElfCore;
import tech.lq0.dreamaticvoyage.item.providencefirst.myanna.Drill;
import tech.lq0.dreamaticvoyage.item.providencefirst.myanna.MountainDestroyer;
import tech.lq0.dreamaticvoyage.item.providencefirst.myanna.Schedule;
import tech.lq0.dreamaticvoyage.item.providencefirst.niina.BananaMilk;
import tech.lq0.dreamaticvoyage.item.providencefirst.unia.ElfWings;
import tech.lq0.dreamaticvoyage.item.providencefirst.unia.EnchantedUnigiri;
import tech.lq0.dreamaticvoyage.item.providencefirst.unia.TaroIceCream;
import tech.lq0.dreamaticvoyage.item.providencefirst.unia.Unigiri;
import tech.lq0.dreamaticvoyage.item.providencefirst.usa.BrownieUzza;
import tech.lq0.dreamaticvoyage.item.providencefirst.usa.Plunger;
import tech.lq0.dreamaticvoyage.item.providencefourth.choco.ChocoalCookie;
import tech.lq0.dreamaticvoyage.item.providencefourth.choco.StrawberryCake;
import tech.lq0.dreamaticvoyage.item.providencefourth.hifumi.NetherLight;
import tech.lq0.dreamaticvoyage.item.providencefourth.sana.JellyfishBottle;
import tech.lq0.dreamaticvoyage.item.providencefourth.sana.Shakana;
import tech.lq0.dreamaticvoyage.item.providencemagicros.chiram.*;
import tech.lq0.dreamaticvoyage.item.providencemagicros.ekira.*;
import tech.lq0.dreamaticvoyage.item.providencemagicros.haine.*;
import tech.lq0.dreamaticvoyage.item.providencemagicros.keroro.*;
import tech.lq0.dreamaticvoyage.item.providencesecond.lecia.ElectricHorn;
import tech.lq0.dreamaticvoyage.item.providencesecond.lecia.MechanicalHorn;
import tech.lq0.dreamaticvoyage.item.providencesecond.louise.*;
import tech.lq0.dreamaticvoyage.item.providencesecond.lucia.BigFierceOneCoffee;
import tech.lq0.dreamaticvoyage.item.providencesecond.lucia.BigMoeOnePotion;
import tech.lq0.dreamaticvoyage.item.providencesecond.lucia.LuciaRiceCake;
import tech.lq0.dreamaticvoyage.item.providencesecond.lucia.MoonlightAmulet;
import tech.lq0.dreamaticvoyage.item.providencesecond.mumu.AyeletMask;
import tech.lq0.dreamaticvoyage.item.providencesecond.mumu.MumuSteak;
import tech.lq0.dreamaticvoyage.item.providencesecond.satou.*;
import tech.lq0.dreamaticvoyage.item.providencethird.hiru.*;
import tech.lq0.dreamaticvoyage.item.providencethird.leciel.ReinaFeather;
import tech.lq0.dreamaticvoyage.item.providencethird.leciel.ReinaWings;
import tech.lq0.dreamaticvoyage.item.providencethird.yuki.FoxIceCream;
import tech.lq0.dreamaticvoyage.item.providencethird.yuki.FoxPudding;
...
//    public static final RegistryObject<Item> UNFAITHFUL_HEART = ITEMS.register("unfaithful_heart", UnfaithfulHeart::new);
    ...
    public static final RegistryObject<Item> APOCRYPHAL_INGOT = ITEMS.register("apocryphal_ingot", ApocryphalIngot::new);
