...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> AUDIO_TAPE_FUKAMIZU_1 = AUDIO_ITEMS.register("audio_tape_fukamizu_1", () -> new AudioTape(Livers.FUKAMI, SoundRegistry.FUKAMIZU_OCEAN_MONUMENT, new Item.Properties(), 5, 200));
    public static final RegistryObject<Item> AUDIO_TAPE_FUKAMIZU_2 = AUDIO_ITEMS.register("audio_tape_fukamizu_2", () -> new AudioTape(Livers.FUKAMI, SoundRegistry.FUKAMIZU_DIAMOND, new Item.Properties(), 5, 120));
    public static final RegistryObject<Item> AUDIO_TAPE_FUKAMIZU_3 = AUDIO_ITEMS.register("audio_tape_fukamizu_3", () -> new AudioTape(Livers.FUKAMI, SoundRegistry.FUKAMIZU_RING, new Item.Properties(), 5, 140));
    public static final RegistryObject<Item> AUDIO_TAPE_FUKAMIZU_4 = AUDIO_ITEMS.register("audio_tape_fukamizu_4", () -> new AudioTape(Livers.FUKAMI, SoundRegistry.FUKAMIZU_CATS, new Item.Properties(), 5, 160));
    public static final RegistryObject<Item> AUDIO_TAPE_FUKAMIZU_5 = AUDIO_ITEMS.register("audio_tape_fukamizu_5", () -> new AudioTape(Livers.FUKAMI, SoundRegistry.FUKAMIZU_MATH, new Item.Properties(), 5, 200));
    public static final RegistryObject<Item> AUDIO_TAPE_FUKAMIZU_6 = AUDIO_ITEMS.register("audio_tape_fukamizu_6", () -> new AudioTape(Livers.FUKAMI, SoundRegistry.FUKAMIZU_SUN_BATH, new Item.Properties(), 5, 320));
