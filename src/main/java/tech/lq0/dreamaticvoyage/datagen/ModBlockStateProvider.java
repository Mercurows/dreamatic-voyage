...
//        doorBlockWithRenderType((DoorBlock) BlockRegistry.FUKAMIZU_PLUM_DOOR.get(), Utils.loc( "block/fukamizu_plum_door_bottom"), Utils.loc( "block/fukamizu_plum_door_top"), "cutout");
        ...
        simpleBlockWithItem(BlockRegistry.CRYSTAL_CUTTER.get(), models().cubeBottomTop("crystal_cutter", Utils.loc("block/crystal_cutter_side"),
                Utils.loc("block/crystal_cutter_bottom"), Utils.loc("block/crystal_cutter_top")));
    }
