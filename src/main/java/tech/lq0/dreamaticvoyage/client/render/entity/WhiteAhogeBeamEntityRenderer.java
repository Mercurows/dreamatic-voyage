 ...
 */
@OnlyIn(Dist.CLIENT)
public class WhiteAhogeBeamEntityRenderer extends AbstractBeamEntityRenderer<WhiteAhogeBeamEntity> {
    ...
    @Override
    protected void renderStart(WhiteAhogeBeamEntity laser, int frame, PoseStack matrixStackIn, VertexConsumer builder, float delta, int packedLightIn) {
