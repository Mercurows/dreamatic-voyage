...
import tech.lq0.dreamaticvoyage.client.models.curios.DarkElfGlassesModel;
...
public class DarkElfGlassesRenderer implements ICurioRenderer {
    ...
    public DarkElfGlassesRenderer() {
        this.model = new DarkElfGlassesModel(Minecraft.getInstance().getEntityModels().bakeLayer(DarkElfGlassesModel.LAYER_LOCATION));
    }
