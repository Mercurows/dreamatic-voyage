            ...
            if (livingEntity instanceof Player player) {
                ...
                if (shooter != null) {
                    if (player.getTeam() == shooter.getTeam()) {
                        ...
                        player.hurt(DamageSourceRegistry.causeBloodCrystalDamage(this.level().registryAccess(), this, this.getOwner()), 4.0f);
                ...
                entity.hurt(DamageSourceRegistry.causeBloodCrystalDamage(this.level().registryAccess(), this, this.getOwner()), 4.0f);
