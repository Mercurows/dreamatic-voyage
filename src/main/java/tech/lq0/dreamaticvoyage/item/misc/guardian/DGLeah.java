...
public class DGLeah extends DreamGuardian {

    public static final ResourceLocation IMAGE = new ResourceLocation(Utils.MOD_ID, "textures/character/leah_default.png");
