...
public class DGKuriko extends DreamGuardian {

    public static final ResourceLocation IMAGE = new ResourceLocation(Utils.MOD_ID, "textures/character/kuriko_default.png");
