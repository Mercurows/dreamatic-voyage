...
import tech.lq0.dreamaticvoyage.client.models.armor.SuccubusTailModel;
...
public class SuccubusTail extends ArmorItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("des.dreamaticvoyage.succubus_tail_2").withStyle(ChatFormatting.GRAY));
