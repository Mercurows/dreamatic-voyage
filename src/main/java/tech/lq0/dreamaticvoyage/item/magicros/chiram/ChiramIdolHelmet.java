...
import tech.lq0.dreamaticvoyage.client.models.armor.ChiramIdolHelmetModel;
...
public class ChiramIdolHelmet extends ArmorItem {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                HumanoidModel<?> armorModel = new HumanoidModel<>(new ModelPart(Collections.emptyList(), Map.of(
                        ...
                        "head", new ChiramIdolHelmetModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(ChiramIdolHelmetModel.LAYER_LOCATION)).main,
    ...
    public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return Utils.MOD_ID + ":textures/models/costume/chiram_idol_helmet.png";
    }
}
