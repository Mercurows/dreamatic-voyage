...
import tech.lq0.dreamaticvoyage.client.models.armor.KeroroIdolBootsModel;
...
public class KeroroIdolBoots extends ArmorItem {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                HumanoidModel<?> armorModel = new HumanoidModel<>(new ModelPart(Collections.emptyList(), Map.of(
                        ...
                        "right_leg", new KeroroIdolBootsModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(KeroroIdolBootsModel.LAYER_LOCATION)).right_total,
                        "left_leg", new KeroroIdolBootsModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(KeroroIdolBootsModel.LAYER_LOCATION)).left_total)));
    ...
    public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return Utils.MOD_ID + ":textures/models/costume/keroro_idol_boots.png";
    }
}
